...
namespace HotelManager.Data
{
    ...
    {
        public SQLiteRepository(HotelDbContext context) : base(context)
        {
        }
    }
    public class SQLiteReservationRepository : SQLiteRepository<Reservation>
    {
        public SQLiteReservationRepository(HotelDbContext context)
            : base(context) { }
